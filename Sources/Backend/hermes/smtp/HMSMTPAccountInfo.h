...
#ifndef __dejalu__HMSMTPAccountInfo__
#define __dejalu__HMSMTPAccountInfo__
...
namespace hermes {
    ...
    class SMTPAccountInfo : public mailcore::Object {

    public:
        SMTPAccountInfo();
        virtual ~SMTPAccountInfo();
    ...
    public: // subclass behavior
        SMTPAccountInfo(SMTPAccountInfo * other);
        virtual Object * copy();
...
#endif /* defined(__dejalu__HMSMTPAccountInfo__) */
